...
Проектное решение (Technical Specification) по реализации системы защищенного удаленного доступа. Данный проект демонстрирует навыки системного анализа, проектирования требований и понимание основ сетевой безопасности.
...
* **FR.04:** Маскирование (хэширование) паролей при передаче и хранении.
...
* [📂/ requirements.md](docs/requirements.md) — Полная спецификация требований (SRS).
