...
* **Сегментация сети:** Визуализировано разделение на **DMZ (демилитаризованную зону)** для внешних запросов и **Internal Zone** для хранения чувствительных данных (Active Directory) и корпоративных ресурсов. Это минимизирует векторы атак на внутреннюю инфраструктуру.
